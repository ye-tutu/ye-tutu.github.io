YL.static = {
  /** “关于”信息 */
  softwareName: 'tutu', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: 'tutu',//作者
  contactInformation: '2093142951@qq.com',//联系方式
  officialWebsite: 'http://hi-tutu.top',//软件官网
  welcome: 'Welcome to tutu\'blog',//加载完毕控制台提示信息
